...
Del mismo modo que el <<keoscluster_section>>, durante la fase de instalación se creará el recurso *ClusterConfig* que permite indicar configuraciones específicas de ese clúster en particular.
