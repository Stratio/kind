...
+
Para asegurar las funcionalidades soportadas por el _control-plane_ gestionado de EKS, se deberán utilizar las imagenes gestionadas por Stratio, las cuales podrán ser consultadas en nuestra documentación _Stratio Generative AI Data Fabric_ en la sección _Artefactos de Stratio Generative AI Data Fabric_.
+
...
* Sistemas operativos certificados
+
Para los entornos en GCP no gestionado se deberán utilizar las imagenes gestionadas por Stratio, las cuales podrán ser consultadas en nuestra documentación _Stratio Generative AI Data Fabric_ en la sección _Artefactos de Stratio Generative AI Data Fabric_.
+
...
* Sistemas operativos certificados
+
Para los entornos en Azure se deberán utilizar las imagenes gestionadas por Stratio, las cuales podrán ser consultadas en nuestra documentación _Stratio Generative AI Data Fabric_ en la sección _Artefactos de Stratio Generative AI Data Fabric_.
+
