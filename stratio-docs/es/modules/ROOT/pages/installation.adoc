...
* Permisos
+
En GKE, la service account con la que se aprovisionan los _clusters_ debe contar con los siguientes conjuntos de permisos.
+
...
Para las imágenes creadas con _image-builder_ (*Azure no gestionado*), hay que añadir el siguiente elemento en el https://github.com/kubernetes-sigs/image-builder/blob/main/images/capi/ansible/roles/node/tasks/main.yml#L55[_loop_ de los parámetros del kernel] (en _/images/capi/ansible/roles/node/tasks/main.yml_):
