...
a|
_** Se ha implementado la opción de establecer min_size como cero, lo que permite que el autoscalado pueda incrementar o disminuir el número de nodos según sea necesario. Esta funcionalidad facilita un ahorro significativo de costos en comparación con versiones anteriores, ya que permite eliminar parte de la infraestructura que no está siendo utilizada._
