...
_** Se ha implementado la opción de establecer min_size como cero, lo que permite que el autoscalado pueda incrementar o disminuir el número de nodos hasta alcanzar cero según sea necesario. Esta funcionalidad facilita un ahorro significativo de costos en comparación con versiones anteriores, ya que posibilita la precreación virtual de parte de la infraestructura o su eliminación en el caso de considerarse no necesaria._
