...
Las imágenes utilizadas deberán estar soportadas por EKS, https://repost.aws/knowledge-center/eks-custom-linux-ami/[Creación de AMI personalizada para EKS]
