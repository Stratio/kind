...
* `<k8s_namespace>` es el _namespace_ donde reside el componente (`kube-system`).
* `<k8s_sa_name>` es el nombre de la cuenta de servicio de Kubernetes (`source-controller`).
