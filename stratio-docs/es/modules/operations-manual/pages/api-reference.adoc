...
| *`capx`* _CAPX_
| Permite definir las versiones de los componentes de Cluster API (CAPI, CAPA, CAPZ, CAPG) y sus imágenes asociadas para el despliegue del clúster. Útil para personalizar versiones de los controladores de infraestructura.
| -
| -

| *`charts`* _array[Chart]_
| Permite especificar una lista de _charts_ que se instalarán en el clúster, indicando nombre y versión de cada uno.
| -
| -
