...
Para el caso de permisos a nivel de _subscripción_, se recomiendan los siguientes permisos:
...
Para el caso de permisos a nivel de _grupo de recursos_, se recomiendan los siguientes permisos:
...
** xref:attachment$stratio-azure-acr.json[Descargar permisos para _usuario de despliegue_ de Azure, _workers_ y _control-plane_]
** Además añadiremos los siguientes permisos a nivel de _grupo de recursos_:
- Usuario de despliegue:
  *** Acrpull para el scope: `/subscriptions/<subscription_id>/resourceGroups/<resource_group>/providers/Microsoft.ContainerRegistry/registries/<acr_name>`
- _Control-plane_:
  *** Acrpull para el scope: `/subscriptions/<subscription_id>/resourceGroups/<resource_group>/providers/Microsoft.ContainerRegistry/registries/<acr_name>`
- _Workers_:
  *** Acrpull para el scope: `/subscriptions/<subscription_id>/resourceGroups/<resource_group>/providers/Microsoft.ContainerRegistry/registries/<acr_name>`
