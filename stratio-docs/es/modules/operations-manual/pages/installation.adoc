...
- `goog-gke-node-pool-provisioning-model`: _Node pool_ de GKE.
...
Para más información sobre las etiquetas automáticas aplicadas por GKE, consulta la documentación oficial de Google: https://docs.cloud.google.com/kubernetes-engine/docs/how-to/creating-managing-labels?utm_source=chatgpt.com#automatically-applied-labels[Etiquetas automáticas en GKE].
