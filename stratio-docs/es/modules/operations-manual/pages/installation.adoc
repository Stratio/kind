...
Dado que este despliegue no está habilitado por defecto, deberá indicarse con _spec.eks_lb_controller_ a "true" en el recurso _ClusterConfig_ del descriptor del _cluster_.
