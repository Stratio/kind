...
* Configurar la _Trust Relationship_ del rol para permitir que un usuario de AWS pueda asumirlo (por ejemplo: _arn:aws:iam::123456789012:user/stratio-user_).
+
