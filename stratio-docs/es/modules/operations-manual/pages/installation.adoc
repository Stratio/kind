...
NOTE: Los pre-requisitos son los mismos que los descritos en la sección xref:operations-manual:operations-manual.adoc#_prerrequisitos[Activar autorización por _assume role_ en AWS para un _cluster_ EKS] del manual de operaciones.
