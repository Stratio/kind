...
- `--local-stratio-image-version`: permite indicar la versión de la imagen de _Stratio Cloud Provisioner_ que se quiere usar al activar la opción `--use-local-stratio-image`.
