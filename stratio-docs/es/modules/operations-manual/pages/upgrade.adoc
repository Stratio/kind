...
NOTE: El _script_ `upgrade-provisioner.py` no forma parte de este repositorio. Está empaquetado dentro de la imagen Docker `stratio-cloud-provisioner-upgrade-image` y se ejecuta desde el entorno del contenedor.
