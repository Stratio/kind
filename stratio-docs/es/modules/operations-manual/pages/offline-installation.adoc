...
** *`spec.private_helm_repo`: _true_*. Con este parámetro se le indica a _Stratio Cloud Provisioner_ que todos los _charts_ necesarios durante el aprovisionamiento e instalación del _cluster_ se deben recuperar del _keos registry_.
* _KeosCluster_:
