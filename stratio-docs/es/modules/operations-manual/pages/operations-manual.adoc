...
Para la generación de imágenes personalizadas en AWS gestionado se ha creado la siguiente xref:operations-manual:image-builder/aws-image-builder.adoc[documentación de referencia].
