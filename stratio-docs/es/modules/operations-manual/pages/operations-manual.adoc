...
En el caso de _EKS_ consultaremos la existencia del pdb `coredns` en el _namespace_ `kube-system` y lo eliminaremos si existe como paso previo a la actualización del _cluster_.
[source,bash]
----
