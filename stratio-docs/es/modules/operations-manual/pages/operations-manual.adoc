...
== Gestión de credentiales

Para saber cómo llevar a cabo la gestión de las credenciales configuradas para el _cluster_, consulta la xref:operations-manual:credentials.adoc[documentación para la gestión de credenciales].
