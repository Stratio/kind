...
** _gcp++_++public++_++cidrs++_++access++_++enabled_ (default: "false", if _enable++_++private++_++endpoint_ is "true") (default: "false"): indicates whether access to Google Compute Engine public IP addresses is allowed.
