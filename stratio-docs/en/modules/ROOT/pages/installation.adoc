...
- `--use-local-stratio-image`: avoids the Stratio cloud-provisioner image build or pull and uses the local image.
- `--build-stratio-image`: builds and uses the Stratio cloud-provisioner image.
