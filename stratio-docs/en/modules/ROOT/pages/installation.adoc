...
For _subscription-level_ permissions, the following permissions are recommended:

** xref:attachment$stratio-azure-role.json[Download permissions for Azure deployment user].
...
For _resource group-level_ permissions, the following permissions are recommended:

** xref:attachment$stratio-azure-role-rg.json[Download permissions for Azure deployment user].
** xref:attachment$stratio-azure-nodes-role-rg.json[Download permissions for Azure _workers_].
** xref:attachment$stratio-azure-cp-role-rg.json[Download permissions for Azure _control-plane_].
** xref:attachment$stratio-azure-acr.json[Download permissions for Azure deployment user, _workers_, and _control-plane_].
** Additionally, the following permissions will be added at the _resource group-level_:
- Deployment user:
  *** Acrpull for the scope: `/subscriptions/<subscription_id>/resourceGroups/<resource_group>/providers/Microsoft.ContainerRegistry/registries/<acr_name>`
- _Control-plane_:
  *** Acrpull for the scope: `/subscriptions/<subscription_id>/resourceGroups/<resource_group>/providers/Microsoft.ContainerRegistry/registries/<acr_name>`
- _Workers_:
  *** Acrpull for the scope: `/subscriptions/<subscription_id>/resourceGroups/<resource_group>/providers/Microsoft.ContainerRegistry/registries/<acr_name>`
