...
* Certified operating systems
+
En los entornos de GCP no gestionados, se deben usar las imágenes proporcionadas por Stratio. Puedes consultarlas en la sección de xref:stratio-generative-ai-data-fabric:ROOT:stratio-generative-ai-data-fabric-artifacts.adoc[artefactos de _Stratio Generative AI Data Fabric_] de la documentación.
+
...
* Certified operating systems
+
En los entornos de Azure, se deben usar las imágenes proporcionadas por Stratio. Puedes consultarlas en la sección de xref:stratio-generative-ai-data-fabric:ROOT:stratio-generative-ai-data-fabric-artifacts.adoc[artefactos de _Stratio Generative AI Data Fabric_] de la documentación.
+
