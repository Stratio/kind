...
* Certified operating systems
+
In unmanaged GCP environments, you must use the images provided by Stratio. You can find them in the xref:stratio-generative-ai-data-fabric:ROOT:stratio-generative-ai-data-fabric-artifacts.adoc#_images_for_cloud_environments[_Stratio Generative AI Data Fabric_ artifacts] section of the documentation.
+
