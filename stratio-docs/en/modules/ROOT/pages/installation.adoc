...
>>>>>>> 1a89e94dc30680355bda77c1aa731279ef2bd706
+
...
* Certified operating systems
+
In managed GCP environments, you must use the images provided by Stratio. You can find them in the xref:stratio-generative-ai-data-fabric:ROOT:stratio-generative-ai-data-fabric-artifacts.adoc#_images_for_cloud_environments[_Stratio Generative AI Data Fabric_ artifacts] section of the documentation.
+
