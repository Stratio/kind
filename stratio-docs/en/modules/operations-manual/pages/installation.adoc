...
NOTE: The prerequisites are the same as those described in the section xref:operations-manual:operations-manual.adoc#_prerrequisitos[Activate authorization by _assume role_ in AWS for an EKS _cluster_] of the operations manual.
