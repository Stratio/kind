...
For more information about the automatic labels applied by GKE, refer to the official Google documentation: https://docs.cloud.google.com/kubernetes-engine/docs/how-to/creating-managing-labels?utm_source=chatgpt.com#automatically-applied-labels[Automatic labels in GKE].
