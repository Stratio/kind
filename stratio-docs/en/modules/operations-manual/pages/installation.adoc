...
* Configuracón de la _Trust relationship_ del IAM Role para permitir el acceso al usuario de AWS que se utilizará para asumir el rol (e.g. `arn:aws:iam::123456789012:user/stratio-user`).
====
...
Nota: La versión mínima de _cluster-operator_ necesaria para utilizar este método de autorización es la 0.5.1.
