...
- `--local-stratio-image-version`: lets you specify the version of the _Stratio Cloud Provisioner_ image to use when the `--use-local-stratio-image` option is enabled.
