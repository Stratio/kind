...
NOTE: The `upgrade-provisioner.py` script is not part of this repository. It is packaged within the `stratio-cloud-provisioner-upgrade-image` Docker image and is executed from within the container environment.
