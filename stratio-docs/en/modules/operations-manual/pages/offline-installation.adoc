...
** *`spec.private_helm_repo`: _true_*. With this parameter, you tell _Stratio Cloud Provisioner_ that all charts needed during provisioning and installation of the cluster should be retrieved from the _keos helm repository_.
* _KeosCluster_:
