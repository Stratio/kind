...
type Provider interface {
	...
	Provision(status *cli.Status, cfg *config.Cluster, dockerRegUrl string, useLocalStratioImage bool, LocalStratioImageVersion string, buildStratioImage bool) error
