...
.. (Requerido para kubernetes 1.27+) Crear binario para la gestión de la autenticación ECR
[source,console]
cd ..
...
.. (*Requerido para kubernetes 1.27+) Añadir binario y fichero de configuración a la automatización
[source,console]
mkdir images/capi/ansible/roles/providers/files
...
.. (Requerido para kubernetes 1.27+) Actualizar automatización para configurar los ficheros ecr-credential-provider
[source,console]
...
* Encuentra más información sobre este requerimiento en los siguientes enlances:
https://kubernetes.io/docs/tasks/administer-cluster/kubelet-credential-provider/
https://github.com/kubernetes-sigs/image-builder/issues/1249
