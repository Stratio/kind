...
NO | elasticloadbalancing:DescribeLoadBalancers | Attempting to describe load balancers | Grants permission to describe the specified the load balancers. |  * | cloud-provisioner
NO | elasticloadbalancing:CreateLoadBalancer | Attempting to create load balancer | Grants permission to create a load balancer. |  arn:aws:elasticloadbalancing:eu-west-1:<account-id>:loadbalancer/* | cloud-provisioner
NO | elasticloadbalancing:AddTags | Attempting to add tags | Grants permission to add one or more tags to the specified load balancer. |  arn:aws:elasticloadbalancing:eu-west-1:<account-id>:loadbalancer/* | cloud-provisioner
NO | elasticloadbalancing:DescribeLoadBalancerAttributes | Attempting to describe load balancer attributes | Grants permission to describe the attributes for the specified load balancer. | * | cloud-provisioner
NO | elasticloadbalancing:DescribeTags | Attempting to describe tags | Grants permission to describe the tags associated with one or more load balancers. |  arn:aws:elasticloadbalancing:eu-west-1:<account-id>:loadbalancer/* | cloud-provisioner
NO | elasticloadbalancing:ModifyLoadBalancerAttributes | Attempting to modify load balancer attributes | Grants permission to modify the attributes for the specified load balancer. |  arn:aws:elasticloadbalancing:eu-west-1:<account-id>:loadbalancer/* | cloud-provisioner
NO | elasticloadbalancing:RegisterInstancesWithLoadBalancer | Attempting to register instances with load balancer | Grants permission to add the specified instances to the specified load balancer. |  arn:aws:elasticloadbalancing:eu-west-1:<account-id>:loadbalancer/* | cloud-provisioner
...
[source,bash]
----
kubectl --kubeconfig local_kubeconfig -n cluster-aws-cl01 delete cluster aws-cl01
----
...
clusterctl --kubeconfig workload_kubeconfig -n cluster-aws-cl01 describe cluster aws-cl01
...
clusterctl --kubeconfig workload_kubeconfig move -n cluster-aws-cl01 --to-kubeconfig local_kubeconfig
Performing move...
...
clusterctl --kubeconfig local_kubeconfig -n cluster-aws-cl01 describe cluster aws-cl01
NAME                                                         READY  SEVERITY  REASON  SINCE  MESSAGE
...
clusterctl --kubeconfig local_kubeconfig move -n cluster-aws-cl01 --to-kubeconfig workload_kubeconfig
Performing move...
Discovering Cluster API objects
Moving Cluster API objects Clusters=1
Moving Cluster API objects ClusterClasses=0
...
clusterctl --kubeconfig remote_kubeconfig -n cluster-aws-cl01 describe cluster aws-cl01
NAME                                                         READY  SEVERITY  REASON  SINCE  MESSAGE
...
[source,bash]
----
kubectl --kubeconfig /home/jnovoa/.kube/configs/remote_kubeconfig -n cluster-aws-cl01 get keosclusters.installer.stratio.com aws-cl01 --subresource status
...
[source,bash]
----
kubectl --kubeconfig /home/jnovoa/.kube/configs/remote_kubeconfig edit keosclusters.installer.stratio.com -n cluster-aws-cl01 aws-cl01
kubectl --kubeconfig /home/jnovoa/.kube/configs/remote_kubeconfig -n cluster-aws-cl01 get keosclusters.installer.stratio.com aws-cl01 --subresource status
NAME       READY   PHASE                   CLUSTER    TRIGGERED
