...
[source,bash]
----
kubectl --kubeconfig local_kubeconfig -n cluster-eks-cl02 delete cluster eks-cl02
----
...
clusterctl --kubeconfig workload_kubeconfig -n cluster-eks-cl02 describe cluster eks-cl02
...
clusterctl --kubeconfig workload_kubeconfig move -n cluster-eks-cl02 --to-kubeconfig local_kubeconfig
Performing move...
...
clusterctl --kubeconfig local_kubeconfig -n cluster-eks-cl02 describe cluster eks-cl02
NAME                                                            READY  SEVERITY  REASON  SINCE  MESSAGE
...
clusterctl --kubeconfig local_kubeconfig move -n cluster-eks-cl02 --to-kubeconfig workload_kubeconfig
Performing move...
Discovering Cluster API objects
Moving Cluster API objects Clusters=1
Moving Cluster API objects ClusterClasses=0
...
clusterctl --kubeconfig remote_kubeconfig -n cluster-eks-cl02 describe cluster eks-cl02
NAME                                                         READY  SEVERITY  REASON  SINCE  MESSAGE
...
[source,bash]
----
kubectl --kubeconfig /home/jnovoa/.kube/configs/remote_kubeconfig -n cluster-eks-cl02 get keosclusters.installer.stratio.com eks-cl02 --subresource status
...
[source,bash]
----
kubectl --kubeconfig /home/jnovoa/.kube/configs/remote_kubeconfig edit keosclusters.installer.stratio.com -n cluster-eks-cl02 eks-cl02
kubectl --kubeconfig /home/jnovoa/.kube/configs/remote_kubeconfig -n cluster-eks-cl02 get keosclusters.installer.stratio.com eks-cl02 --subresource status
NAME       READY   PHASE                   CLUSTER    TRIGGERED
